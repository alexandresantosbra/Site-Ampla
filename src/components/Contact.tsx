...
const Contact: React.FC<ContactProps> = ({ isOpen, onClose }) => {
  const handleWhatsAppClick = () => {
    ...
    const message = encodeURIComponent('Olá! Gostaria de saber mais sobre os materiais de construção da ConstruMax.');
    const whatsappUrl = `https://wa.me/${phoneNumber}?text=${message}`;
    window.open(whatsappUrl, '_blank');
  };

  const handleInstagramClick = () => {
    const instagramUrl = 'https://instagram.com/construmax_oficial'; // Substitua pelo Instagram real
    window.open(instagramUrl, '_blank');
  };

  const handleEmailClick = () => {
    const email = 'marajocimentos@gmail.com';
    const subject = encodeURIComponent('Contato - ConstruMax');
    const body = encodeURIComponent('Olá! Gostaria de mais informações sobre os produtos da ConstruMax.');
          ...
          <div className="p-6 space-y-4">
            ...
            >
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-purple-100 text-sm">@construmax_oficial</p>
